...
function modifyDOM() {
	...
	function downloadUrl(url, callback,href2) {
  //  console.log("url="+url);
		    ...
		    request.onreadystatechange = function() {
		      if (request.readyState == 4) {
		        ...
		        callback(request, request.status,url);
		      }
		    };
	...
	$.ajax({
	   ...
	   url : 'http://recherche.fnac.com/SearchResult/ResultList.aspx?Search=i5&SFilt=0.0_15300.0!9%2c35760!23&sft=1&sl=0.845',
	  ...
	  // Do something to each item here...
		      if(($(this)).has( 'a' ).length){
		         ...
		         $(this).find('a').each(function() {
                  ...
                  href2=href;
                  if(href!=null)
                        if(href.indexOf('http')!=-1 && href.indexOf('http://www.fnac.com/mp')!=-1)
                        {
